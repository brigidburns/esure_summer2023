...
save('combined_all_profile_data_rad.mat','all_U_profiles','all_theta_profiles','all_q_profiles','all_k_profiles','all_p_profiles');
save('combined_constants_rad.mat','rho','cpa','cpl','cpv','Lv','pbl_height','max_height',...
