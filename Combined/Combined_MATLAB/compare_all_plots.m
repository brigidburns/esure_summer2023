...
% Load the data written by Bin_KatrinaSondeData.mat and
% Bin_KatrinaProcessedSondeData.mat
load('combined_all_profile_data_rad.mat')
load('combined_all_processed_profile_data_rad.mat')
load('combined_constants_rad.mat')
...
for i=1:num_rad_bins
    ...
    legend('Original','Processed','location','southeast'); 
    set(gca,'FontName','Times New Roman','linewidth',1.5,'fontsize',16); 
    title('Katrina, Kyle and Sandy')
end