...
save('combined_all_processed_profile_data_rad.mat','all_processed_U_profiles','all_processed_theta_profiles','all_processed_q_profiles','all_processed_k_profiles','all_processed_p_profiles');
save('combined_processed_constants_rad.mat','rho','cpa','cpl','cpv','Lv','pbl_height','max_height',...
