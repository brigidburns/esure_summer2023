...
all_dc_U_profiles = cell(num_z,num_rad_bins,num_wind_bins);
...
all_dc_p_profiles = cell(num_z,num_rad_bins,num_wind_bins);
all_dc_q_profiles = cell(num_z,num_rad_bins,num_wind_bins);
all_dc_k_profiles = cell(num_z,num_rad_bins,num_wind_bins);
all_dc_theta_profiles = cell(num_z,num_rad_bins,num_wind_bins);
                ...
                if (radbin~=0 && ~isnan(radbin) && ~isnan(windbin))
                    ...
                    for j=1:length(z)
                        if (z(j)<max_height&&z(j)>min_height)
                            ...
                            all_dc_U_profiles{zidx,radbin,windbin} = [all_dc_U_profiles{zidx,radbin,windbin} WS(j)];
                            ...
                            all_dc_p_profiles{zidx,radbin,windbin} = [all_dc_p_profiles{zidx,radbin,windbin} p(j)];
                            all_dc_q_profiles{zidx,radbin,windbin} = [all_dc_q_profiles{zidx,radbin,windbin} q(j)];
                            all_dc_k_profiles{zidx,radbin,windbin} = [all_dc_k_profiles{zidx,radbin,windbin} k(j)];
                            all_dc_theta_profiles{zidx,radbin,windbin} = [all_dc_theta_profiles{zidx,radbin,windbin} theta(j)];
                        end
                    end % z-grid
...
%% Saving Variables
save('../Output_Files/combined_all_dc_profiles_data_rad.mat','all_dc_U_profiles','all_dc_theta_profiles','all_dc_q_profiles','all_dc_k_profiles','all_dc_p_profiles');